...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
  <title>CMAKE_HOST_SYSTEM_PROCESSOR &mdash; CMake 3.18.2 Documentation</title>
...
<code class="docutils literal notranslate"><span class="pre">PROCESSOR_ARCHITECTURE</span></code>. On systems that support <code class="docutils literal notranslate"><span class="pre">uname</span></code>, this variable is
set to the output of:</p>
<ul class="simple">
<li><p><code class="docutils literal notranslate"><span class="pre">uname</span> <span class="pre">-m</span></code> on GNU, Linux, Cygwin, Darwin, Android, or</p></li>
